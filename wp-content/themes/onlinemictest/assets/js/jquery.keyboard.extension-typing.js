    ...
    return this.each(function () {
      ...
      base.typing_setup_reset = function () {
        var kbevents = $keyboard.events,
          ...
          events = [kbevents.kbHidden, kbevents.kbInactive, ""].join(
            namespace + " "
          );
        // reset "typeIn" when keyboard is closed
        base.$el.unbind(namespace).bind(events, function () {
          base.typing_reset();
        });
        base.$allKeys
          .unbind(namespace)
      ...
      base.typing_setup = function () {
        ...
        base.$el.bind(
          $keyboard.events.kbBeforeVisible + namespace,
          function () {
            base.typing_setup();
          }
        );
      ...
      if (o.showTyping && base.options.alwaysOpen && base.isVisible()) {
        ...
        base.$el
          ...
          .bind(
            $keyboard.events.kbBeforeVisible + base.typing_namespace,
            function () {
              if (o.showTyping) {
                base.typing_setup();
              } else {
